...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.resize(config.get("window.width", 1200), config.get("window.height", 800))
        ...
        self.tab_widget.addTab(
            self.benchmark_tab, self.tr("benchmark")
        )  # 添加跑分标签页
    ...
    def update_ui_text(self):
        ...
        for i in range(self.lang_combo.count()):
            ...
            lang_name = self.language_manager.supported_languages.get(
                lang_code, lang_code
            )
