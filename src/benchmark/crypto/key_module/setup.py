            ...
            if os.path.exists(build_path):
                ...
                if platform_dir:
                    ...
                    prebuilt_dir = os.path.join(
                        current_dir, "prebuilt", platform_dir, py_version
                    )
                    ...
                    # 复制到预编译目录
                    target_prebuilt = os.path.join(
                        prebuilt_dir, os.path.basename(filename)
                    )
...
setup(
    ...
    ext_modules=cythonize(
        ext_modules, compiler_directives={"language_level": "3", "embedsignature": True}
    ),
    zip_safe=False,
    cmdclass={
